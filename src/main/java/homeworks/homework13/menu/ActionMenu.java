...
import homeworks.homework13.model.Man;
import homeworks.homework13.model.Woman;
    ...
    public void showMenu() {
        while (true) {
            int menu = InputUtil.requireNumber("------MENU------"
                    ...
                    + "\n10. Save data locally to your computer "
...
//                    }while();
                ...
                case 10:
                    try {
                        ...
                        System.out.println(" You did not save data locally to your computer");
                    }
                    ;
                    break;
                case 11:
                    try {
                        ...
                        System.out.println("You can not read ");
